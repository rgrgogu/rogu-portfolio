  ...
  return (
    <div className="py-1 px-4 flex items-center justify-center">
      <nav className="flex items-center space-x-2">
        <a
          className="text-gray-900 hover:text-blue-600 p-4 inline-flex items-center gap-2 font-medium rounded-md"
          href="#"
        >
        ...
        <a
          className="w-10 h-10 text-gray-900 hover:text-blue-600 p-4 inline-flex items-center text-sm font-medium rounded-full"
          href="#"
        >
          2
        </a>
